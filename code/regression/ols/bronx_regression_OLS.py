...
ewm_file = PROJECT_ROOT / "data/processed/borough/bronx_regression_ready.csv"
...
# Filter to Bronx
# -----------------------------
demo_borough = demo[demo["borough"] == "Bronx"].copy()

print("Bronx demographic rows:", len(demo_borough))
...
results_table.to_csv(RESULTS_DIR / "bronx_model_tests_coefficients.csv", index=False)
summary_table.to_csv(RESULTS_DIR / "bronx_model_tests_summary.csv", index=False)
merged.to_csv(PROJECT_ROOT / "data/processed/borough/bronx_regression_ready.csv", index=False)

print("\nSaved files:")
print(RESULTS_DIR / "bronx_model_tests_coefficients.csv")
print(RESULTS_DIR / "bronx_model_tests_summary.csv")
print(PROJECT_ROOT / "data/processed/borough/bronx_regression_ready.csv")
