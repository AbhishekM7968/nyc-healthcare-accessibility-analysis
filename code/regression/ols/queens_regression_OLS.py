...
print("Queens demographic rows:", len(demo_borough))
...
results_table.to_csv(RESULTS_DIR / "queens_model_tests_coefficients.csv", index=False)
summary_table.to_csv(RESULTS_DIR / "queens_model_tests_summary.csv", index=False)
merged.to_csv(PROJECT_ROOT / "data/processed/borough/queens_regression_ready.csv", index=False)

print("\nSaved files:")
print(RESULTS_DIR / "queens_model_tests_coefficients.csv")
print(RESULTS_DIR / "queens_model_tests_summary.csv")
print(PROJECT_ROOT / "data/processed/borough/queens_regression_ready.csv")
