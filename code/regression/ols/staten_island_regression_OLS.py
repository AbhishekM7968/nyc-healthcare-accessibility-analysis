...
ewm_file = PROJECT_ROOT / "data/processed/borough/staten_island_regression_ready.csv"
...
# -----------------------------
# Filter to Staten Island
# -----------------------------
demo_borough = demo[demo["borough"] == "Staten Island"].copy()

print("Staten Island demographic rows:", len(demo_borough))
...
results_table.to_csv(RESULTS_DIR / "staten_island_model_tests_coefficients.csv", index=False)
summary_table.to_csv(RESULTS_DIR / "staten_island_model_tests_summary.csv", index=False)
merged.to_csv(PROJECT_ROOT / "data/processed/borough/staten_island_regression_ready.csv", index=False)

print("\nSaved files:")
print(RESULTS_DIR / "staten_island_model_tests_coefficients.csv")
print(RESULTS_DIR / "staten_island_model_tests_summary.csv")
print(PROJECT_ROOT / "data/processed/borough/staten_island_regression_ready.csv")
