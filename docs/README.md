...
This folder explains the research design, data, workflow, and major analytical decisions behind the NYC healthcare accessibility project.

## Files

- [`methodology.md`](methodology.md) describes the study design, transit-routing workflow, Entropy Weight Method, spatial analysis, and regression models.
